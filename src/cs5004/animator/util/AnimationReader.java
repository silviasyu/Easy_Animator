...
public class AnimationReader {
   ...
   * @return the final document of the model of type IModel
   */
  ...
  private static <IModel> void readCanvas(Scanner s, AnimationBuilder<IModel> builder) {
    int[] vals = new int[4];
  ...
  private static <IModel> void readShape(Scanner s, AnimationBuilder<IModel> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static <IModel> void readMotion(Scanner s, AnimationBuilder<IModel> builder) {
